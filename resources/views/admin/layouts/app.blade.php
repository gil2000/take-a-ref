...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar accordion toggled" id="accordionSidebar" style="background: #b8e2ea">
            <!-- Sidebar - Brand -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <!-- Topbar -->
                <nav class="navbar navbar-expand topbar static-top shadow-sm" style="background: #b8e2ea">
