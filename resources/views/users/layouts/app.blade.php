...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm" style="background: #B5D6D6;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <li class="nav-item dropdown rounded" style="color: black; background: #6EAFAF">
...
<script>
    ...
    $(document).ready(function(){
        $('.checka').click(function() {
            $('.checka').not(this).prop('checked', false);
        });
    });
</script>
